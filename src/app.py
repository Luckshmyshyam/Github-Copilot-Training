...
activities = {
    "Basketball": {
        ...
        "Soccer": {
        "description": "Competitive soccer league and friendly matches",
        ...
        "Debate Team": {
        "description": "Compete in debates and public speaking competitions",
        "schedule": "Mondays and Thursdays, 3:30 PM - 4:45 PM",
        "max_participants": 16,
        "participants": ["mason@mergington.edu"]
        },
        "Science Club": {
        "description": "Explore chemistry, biology, and physics experiments",
